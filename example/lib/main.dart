...
void main() {
  ...
  // WARNING: Enabling logSensitiveData will print session keys and personal
  // data (e.g. MRZ, document number, date of birth) to the console log.
  // Keep it disabled unless debugging the protocol locally.
  ...
  void _readMRTD({required AccessKey accessKey, bool isPace = false}) async {
    try {
      ...
      try {
        ...
        await _nfc.setIosAlertMessage("Trying to read EF.CardAccess ...");
        ...
        await _nfc.setIosAlertMessage("Trying to read EF.CardSecurity ...");
        ...
        await _nfc.setIosAlertMessage("Initiating session with PACE...");
        //set MrtdData
        ...
        if (isPace) {
          ...
          if (mrtdData.cardAccess == null) {
            // EF.CardAccess could not be read - passport most likely
            // doesn't support PACE. Fail gracefully instead of crashing.
            _log.error(
                "Can't establish PACE session: EF.CardAccess could not be read");
            setState(() {
              _alertMessage =
                  "PACE is not supported by this passport.\nTry reading with BAC instead (untick PACE).";
            });
            return;
          }
        ...
        if (mrtdData.com!.dgTags.contains(EfDG15.TAG)) {
          ...
          await _nfc.setIosAlertMessage(formatProgressMsg("Doing AA ...", 60));
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            ...
                            PlatformElevatedButton(
                              // btn Read MRTD
                              onPressed: _isReading ? null : _buttonPressed,
                              child: PlatformText(
