...
void main() {
  group('HEX encoding/decoding', () {
    test('Encoding Uint8List to HEX string', () {
      expect(
          ...
          "000102030405060708090a0b0c0d0e0f112233445566778899aabbccddeeff");
    });
    ...
    test('Decoding Uint8List from HEX string', () {
      ...
      expect(
          () => "00102030405060708090A0B0C0D0E0F112233445566778899AABBCCDDEEFF"
              .parseHex(),
          throwsFormatException);
    });
  });
  ...
  group('Base64 encoding/decoding', () {
    ...
    test('Encoding Uint8List to base64 string', () {
      ...
      expect(
          ...
          "AAECAwQFBgcICQoLDA0ODxEiM0RVZneImaq7zN0=");
      expect(
          Uint8List.fromList([
            0x00,
            0x01,
          ...
          "AAECAwQFBgcICQoLDA0ODxEiM0RVZneImaq7zN3u");
      expect(
          Uint8List.fromList([
            0x00,
            0x01,
          ...
          "AAECAwQFBgcICQoLDA0ODxEiM0RVZneImaq7zN3u/w==");
    });
    ...
    test('Decoding Uint8List from base64 string', () {
      ...
      expect(
          "AAECAwQFBgcICQoLDA0ODxEiM0RVZneImaq7zN0=".parseBase64(),
          Uint8List.fromList([
            0x00,
            0x01,
            0x02,
      ...
      expect(
          "AAECAwQFBgcICQoLDA0ODxEiM0RVZneImaq7zN3u".parseBase64(),
          Uint8List.fromList([
            0x00,
            0x01,
            0x02,
      ...
      expect(
          "AAECAwQFBgcICQoLDA0ODxEiM0RVZneImaq7zN3u/w==".parseBase64(),
          Uint8List.fromList([
            0x00,
            0x01,
            0x02,
  ...
  group('Date YYMMDD format test', () {
    ...
    test('Converting DateTime to YYMMDD format string', () {
      ...
      expect(
          '891109'.parseDateYYMMDD(futureDate: false), DateTime(1989, 11, 9));
      expect(
          '760501'.parseDateYYMMDD(futureDate: false), DateTime(1976, 05, 01));
      expect(
          '000215'.parseDateYYMMDD(futureDate: false), DateTime(2000, 02, 15));
      expect(
          '111111'.parseDateYYMMDD(futureDate: false), DateTime(2011, 11, 11));
      expect(
          '121212'.parseDateYYMMDD(futureDate: false), DateTime(2012, 12, 12));
      expect(
          '201212'.parseDateYYMMDD(futureDate: false), DateTime(2020, 12, 12));

      expect('891109'.parseDateYYMMDD(futureDate: true), DateTime(1989, 11, 9));
      expect(
          '760501'.parseDateYYMMDD(futureDate: true), DateTime(1976, 05, 01));
      expect(
          '000215'.parseDateYYMMDD(futureDate: true), DateTime(2000, 02, 15));
      expect(
          '111111'.parseDateYYMMDD(futureDate: true), DateTime(2011, 11, 11));
      expect(
          '121212'.parseDateYYMMDD(futureDate: true), DateTime(2012, 12, 12));
      expect(
          '201212'.parseDateYYMMDD(futureDate: true), DateTime(2020, 12, 12));
      ...
      expect(nextMonth.formatYYMMDD().parseDateYYMMDD() != nextMonth,
          true); // by default future date is not expected
      expect(
          nextMonth.formatYYMMDD().parseDateYYMMDD(futureDate: false) !=
              nextMonth,
          true);
      expect(
          nextMonth.formatYYMMDD().parseDateYYMMDD(futureDate: true) ==
              nextMonth,
          true);
      ...
      expect(tenFromNow.formatYYMMDD().parseDateYYMMDD() != tenFromNow,
          true); // by default future date is not expected
      expect(
          tenFromNow.formatYYMMDD().parseDateYYMMDD(futureDate: false) !=
              tenFromNow,
          true);
      expect(
          tenFromNow.formatYYMMDD().parseDateYYMMDD(futureDate: true) ==
              tenFromNow,
          true);

      // 10 years and 6 months future date
      final tenAnd6MonthsFromNow =
          DateTime(now.year + 10, now.month + 6, now.day);
      final ninetyYearsAgo = DateTime(now.year - 90, now.month + 6, now.day);
      expect(tenAnd6MonthsFromNow.formatYYMMDD().parseDateYYMMDD(),
          ninetyYearsAgo);
      expect(
          tenAnd6MonthsFromNow
              .formatYYMMDD()
              .parseDateYYMMDD(futureDate: false),
          ninetyYearsAgo);
      expect(
