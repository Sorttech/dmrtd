...
void testProtecting(
    ...
    final SSC ssc,
    final Uint8List tvMaskedHeader,
    final Uint8List? tvDataDO,
    final Uint8List tvDO97,
    final Uint8List tvM,
    final Uint8List tvN,
    final Uint8List tvCC,
    final Uint8List tvDO8E,
    final Uint8List tvRawProtectedCmd) {
...
void testUprotecting(
    final ResponseAPDU rapdu,
    final SMCipher cipher,
    final SSC ssc,
    final Uint8List? tvDataDO,
    final Uint8List tvDO99,
    final Uint8List tvDO8E,
    final Uint8List tvK,
    final Uint8List tvCC,
    final Uint8List? tvDecryptedData,
    final Uint8List tvRawUnprotectedRAPDU) {
  ...
  expect(dataDO != null ? TLV.encode(dataDO.tag.value, dataDO.value) : null,
      tvDataDO);
...
void main() {
  test('Testing MRTD Secure Messaging', () {
    ...
    var tvCmdAPDU = CommandAPDU(
        cla: 0x00, ins: 0xA4, p1: 0x02, p2: 0x0C, data: "011E".parseHex());
    ...
    testProtecting(tvCmdAPDU, smCipher, tvSSC, tvMaskedHeader, tvDataDO, tvDO97,
        tvM, tvN, tvCC, tvDO8E, tvProtectedCmd);

    var tvProtectedRAPDU =
    ...
    testUprotecting(tvProtectedRAPDU, smCipher, tvSSC, tvDataDO, tvDO99, tvDO8E,
        tvK, tvCC, tvDecryptedData, tvRawUnprotectedRAPDU);
    ...
    tvProtectedRAPDU = ResponseAPDU.fromBytes(
        "871901FB9235F4E4037F2327DCC8964F1F9B8C30F42C8E2FFF224A990290008E08C8B2787EAEA07D749000"
            .parseHex());
    tvDataDO =
        "871901FB9235F4E4037F2327DCC8964F1F9B8C30F42C8E2FFF224A".parseHex();
    tvDO99 = "99029000".parseHex();
    ...
    tvRawUnprotectedRAPDU =
        "04303130365F36063034303030305C0261759000".parseHex();
