...
void main() {
  test('PACE session establishment test(with DBA) - ECDH', () {
    ...
    final tvKeySeed =
        "7e2d2a41c74ea0b38cd36f863939bfa8e9032aad".parseHex(); //changed
    ...
    final initializePaceMsgTerminal =
        "0022C1A40F800A04007F00070202040202830101".parseHex();
    ...
    final generalAuthenticateStep2MsgTerminal =
        "10860000457C438141047ACF3EFC982EC45565A4B1"
                ...
                "8E70C25AF71777A9C4922D00"
            .parseHex();
    final generalAuthenticateStep2MsgChip =
        "7C43824104824FBA91C9CBE26BEF53A0EBE7342A3B"
    ...
    final generalAuthenticateStep4MsgChip =
        "7C0A86083ABB9674BCE93C089000".parseHex();
    ...
    expect(terminal.getPubKey().toBytes(),
    ...
    //
    ECPoint terminalMappingPoint =
        chip.getSharedSecret(otherPubKey: terminal.publicKey);
    ECPoint chipMappingPoint =
    ...
    ECPoint terminalGeneratorPoint = chip.getMappedGenerator(
    ...
    expect(ECDHPace.ecPointToList(point: terminalGeneratorPoint).toBytes(),
        Uint8List.fromList([...mappedGeneratorX, ...mappedGeneratorY]));
    ...
    expect(step2Chip.public.toBytes(),
        Uint8List.fromList([...chipPublicKeyX, ...chipPublicKeyY]));
    ...
    expect(
        ...
        Uint8List.fromList(
            [...terminalEphemeralPublicKeyX, ...terminalEphemeralPublicKeyY]));
    ...
    expect(
        ...
        Uint8List.fromList(
            [...chipEphemeralPublicKeyX, ...chipEphemeralPublicKeyY]));

    //check ephemeral key pair shared secret
    ECPoint terminalEphemeralSharedSecret = terminal.getEphemeralSharedSecret(
        otherEphemeralPubKey: chip.ephemeralPublicKey);
    ECPoint chipEphemeralSharedSecret = chip.getEphemeralSharedSecret(
    ...
    expect(
        calcInputDataTTerminal.sublist(0, 82), decryptedTByAES.sublist(0, 82));
