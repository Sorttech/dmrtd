...
void _testStatusWord(StatusWord sw,
    {required int sw1,
    required int sw2,
...
void main() {
  test('Command APDU test', () {
    // Test case 1 - no data
    expect(CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30).toBytes(),
        "00102030".parseHex());
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: null)
            .toBytes(),
        "00102030".parseHex());
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, ne: 0xA0)
            .toBytes(),
        "00102030A0".parseHex());
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, ne: 256)
            .toBytes(),
        "0010203000".parseHex()); //ne: 256 should be serialized as 0x00
    expect(
        CommandAPDU(
                cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: null, ne: 256)
            .toBytes(),
        "0010203000".parseHex()); //ne: 256 should be serialized as 0x00
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, ne: 0xAABB)
            .toBytes(),
        "0010203000AABB".parseHex());
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, ne: 65536)
            .toBytes(),
        "00102030000000"
            .parseHex()); //ne: 65536 should be serialized as 0x00 0x00
    expect(
        CommandAPDU(
                cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: null, ne: 65536)
            .toBytes(),
        "00102030000000"
            .parseHex()); //ne: 65536 should be serialized as 0x00 0x00
    ...
    expect(
        CommandAPDU(
                ...
                p1: 0x20,
                p2: 0x30,
                data: "0102030405060708".parseHex())
            .toBytes(),
        "00102030080102030405060708".parseHex());
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                ...
                ne: 0xA0)
            .toBytes(),
        "00102030080102030405060708A0".parseHex());
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                ...
                ne: 256)
            .toBytes(),
        "0010203008010203040506070800"
            .parseHex()); //ne: 256 should be serialized as 0x00
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                ...
                ne: 0x0180)
            .toBytes(),
        "0010203000000801020304050607080180".parseHex());
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                ...
                ne: 65536)
            .toBytes(),
        "0010203000000801020304050607080000"
            .parseHex()); //ne: 65536 should be serialized as 0x00 0x00
    ...
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: data)
            .toBytes(),
        tv);

    tv = Uint8List.fromList("00102030000100".parseHex() +
        data +
        "00A0".parseHex()); // Due to extended Lc, Le is encoded as 2 bytes
    expect(
        CommandAPDU(
                cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: data, ne: 0xA0)
            .toBytes(),
        tv);

    tv = Uint8List.fromList("00102030000100".parseHex() +
        data +
        "0000".parseHex()); // Due to extended Lc, Le is encoded as 2 bytes
    expect(
        CommandAPDU(
                cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: data, ne: 256)
            .toBytes(),
        tv);

    tv = Uint8List.fromList("00102030000100".parseHex() +
        data +
        "0180".parseHex()); // Due to extended Lc, Le is encoded as 2 bytes
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
    ...
    expect(
        CommandAPDU(
                cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, data: data, ne: 65536)
            .toBytes(),
        tv);
    ...
    expect(CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30).toBytes(),
        "00102030".parseHex()); // Case 1 Command APDU
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, ne: 0x80)
            .toBytes(),
        "0010203080".parseHex()); // Case 2s Command APDU
    expect(
        CommandAPDU(cla: 0x00, ins: 0x10, p1: 0x20, p2: 0x30, ne: 0x180)
            .toBytes(),
        "00102030000180".parseHex()); // Case 2e Command APDU
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                p1: 0x20,
                p2: 0x30,
                data: "41424344".parseHex())
            .toBytes(),
        "001020300441424344".parseHex()); // Case 3s Command APDU
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                ...
                ne: 0x80)
            .toBytes(),
        "00102030044142434480".parseHex()); // Case 4s Command APDU
    expect(
        CommandAPDU(
                cla: 0x00,
                ins: 0x10,
                ...
                ne: 0x180)
            .toBytes(),
        "00102030000004414243440180".parseHex()); // Case 4e Command APDU
  }, tags: ['iso7816']);

  test('StatusWord tests', () {
    // Success
    _testStatusWord(StatusWord.success,
        sw1: 0x90,
        sw2: 0x00,
        isSuccess: true,
        isWarning: false,
        isError: false,
        description: 'Success');
    _testStatusWord(StatusWord.remainingAvailableResponseBytes(32),
        sw1: StatusWord.sw1SuccessWithRemainingBytes,
        sw2: 0x20,
        isSuccess: true,
        isWarning: false,
        isError: false,
        description: '32 byte(s) are still available');

    // Warnings
    _testStatusWord(StatusWord.noInformationGiven,
        sw1: 0x62,
        sw2: 0x00,
        isSuccess: false,
        isWarning: true,
    ...
    _testStatusWord(StatusWord.possibleCorruptedData,
        sw1: 0x62,
        sw2: 0x81,
        isSuccess: false,
        isWarning: true,
        isError: false,
        description: 'Part of returned data my be corrupted');
    _testStatusWord(StatusWord.unexpectedEOF,
        sw1: 0x62,
        sw2: 0x82,
        isSuccess: false,
        isWarning: true,
        isError: false,
        description: 'End of file reached before reading Le bytes');
    _testStatusWord(StatusWord.selectedFileInvalidated,
        sw1: 0x62,
        sw2: 0x83,
        isSuccess: false,
        isWarning: true,
    ...
    _testStatusWord(StatusWord.wrongFCIFormat,
        sw1: 0x62,
        sw2: 0x84,
        isSuccess: false,
        isWarning: true,
        isError: false,
        description: 'FCI not formatted according to 5.1.5');

    // Errors
    _testStatusWord(StatusWord.wrongLength,
        sw1: 0x67,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Wrong length (e.g. wrong Le field)');
    _testStatusWord(StatusWord.claFunctionNotSupported,
        sw1: 0x68,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Functions in CLA not support');
    _testStatusWord(StatusWord.logicalChannelNotSupported,
        sw1: 0x68,
        sw2: 0x81,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.secureMessagingNotSupported,
        sw1: 0x68,
        sw2: 0x82,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.commandNotAllowed,
        sw1: 0x69,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.incompatibleFileStructureCommand,
        sw1: 0x69,
        sw2: 0x81,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.securityStatusNotSatisfied,
        sw1: 0x69,
        sw2: 0x82,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.authenticationMethodBlocked,
        sw1: 0x69,
        sw2: 0x83,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.referencedDataInvalidated,
        sw1: 0x69,
        sw2: 0x84,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Referenced data invalidated');
    _testStatusWord(StatusWord.conditionsNotSatisfied,
        sw1: 0x69,
        sw2: 0x85,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.commandNotAllowedNoEF,
        sw1: 0x69,
        sw2: 0x86,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.smDataMissing,
        sw1: 0x69,
        sw2: 0x87,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Expected SM data objects missing');
    _testStatusWord(StatusWord.smDataInvalid,
        sw1: 0x69,
        sw2: 0x88,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'SM data objects incorrect');
    _testStatusWord(StatusWord.wrongParameters,
        sw1: 0x6A,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.invalidDataFieldParameters,
        sw1: 0x6A,
        sw2: 0x80,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Incorrect parameters in the data field');
    _testStatusWord(StatusWord.notSupported,
        sw1: 0x6A,
        sw2: 0x81,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.fileNotFound,
        sw1: 0x6A,
        sw2: 0x82,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.recordNotFound,
        sw1: 0x6A,
        sw2: 0x83,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.notEnoughSpaceInFile,
        sw1: 0x6A,
        sw2: 0x84,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Not enough memory space in the file');
    _testStatusWord(StatusWord.lcInconsistentWithTLV,
        sw1: 0x6A,
        sw2: 0x85,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.incorrectParameters,
        sw1: 0x6A,
        sw2: 0x86,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.lcInconsistentWithParameters,
        sw1: 0x6A,
        sw2: 0x87,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.referencedDataNotFound,
        sw1: 0x6A,
        sw2: 0x88,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.wrongParameters2,
        sw1: 0x6B,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Wrong parameter(s) P1-P2');
    _testStatusWord(StatusWord.invalidInstructionCode,
        sw1: 0x6D,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.classNotSupported,
        sw1: 0x6E,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
    ...
    _testStatusWord(StatusWord.noPreciseDiagnostics,
        sw1: 0x6F,
        sw2: 0x00,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'No precise diagnosis');
    _testStatusWord(StatusWord.leWrongLength(32),
        sw1: StatusWord.sw1WrongLengthWithExactLength,
        sw2: 0x20,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'Wrong length (exact length: 32)');

    var random = Random.secure();
    var rsw1 = 0x91 + random.nextInt(256) % 0x6E;
    var rsw2 = random.nextInt(256);
    _testStatusWord(StatusWord(sw1: rsw1, sw2: rsw2),
        sw1: rsw1,
        sw2: rsw2,
        isSuccess: false,
        isWarning: false,
        isError: true,
        description: 'sw=${((rsw1 << 8) + rsw2).hex()}');
    ...
    expect(
        () => StatusWord.fromBytes('0000'.parseHex(), 1), throwsArgumentError);
  }, tags: ['iso7816']);
