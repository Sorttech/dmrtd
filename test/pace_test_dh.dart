...
void main() {
  test('PACE session establishment test(with DBA) - DH', () {
    ...
    Uint8List terminalPublicKey = "23FB3749EA030D2A25B278D2A562047A"
    ...
    Uint8List chipPublicKey = "78879F57225AA8080D52ED0FC890A4B2"
    ...
    Uint8List sharedSecret = "5BABEBEF5B74E5BA94B5C063FDA15F1F"
            ...
            "1279270CB0750C0D37C57FFFE302AE7F"
        .parseHex();

    Uint8List mappedGenerator = "7C9CBFE98F9FBDDA8D143506FA7D9306"
            ...
            "2D401325B37EE8565FFCDEE618342DC5"
        .parseHex();

    Uint8List terminalEphemeralPrivateKey =
        '89CCD99B0E8D3B1F11E1296DCA68EC53411CF2CA'.parseHex();

    Uint8List terminalEphemeralPublicKey = "907D89E2D425A178AA81AF4A7774EC"
            ...
            "E397545D015C175EB5130551EDBC2EE5D4"
        .parseHex();

    Uint8List chipEphemeralPrivateKey =
        'A5B780126B7C980E9FCEA1D4539DA1D27C342DFA'.parseHex();
    ...
    Uint8List sharedSecretEphemeral = "6BABC7B3A72BCD7EA385E4C62DB2625B"
    ...
    final inputDataTTerminal = "7F49818F060A04007F00070202040102"
    ...
    final inputDataTChip = "7F49818F060A04007F00070202040102"
    ...
    final initializePaceMsgTerminal =
        "0022C1A40F800A04007F00070202040102830101".parseHex();

    final generalAuthenticateStep1MsgTerminal = "10860000027C0000".parseHex();
    final generalAuthenticateStep1MsgChip =
        "7C128010854D8DF5827FA6852D1A4FA701CDDDCA9000".parseHex();

    final generalAuthenticateStep2MsgTerminal =
        "10860000867C818381818023FB3749EA030D2A25B278D2A5"
                ...
                "710F461AFE710FBBBC5F8BA166F4311975EC6C00"
            .parseHex();

    final generalAuthenticateStep2MsgChip =
        "7C818382818078879F57225AA8080D52ED0FC890A4B25336"
                ...
                "AFC14F84D8258950A91B44126EE69000"
            .parseHex();

    final generalAuthenticateStep3MsgTerminal =
        "10860000867C8183838180907D89E2D425A178AA81AF4A77"
                ...
                "3C5CE397545D015C175EB5130551EDBC2EE5D400"
            .parseHex();

    final generalAuthenticateStep3MsgChip =
        "7C8183848180075693D9AE941877573E634B6E644F8E60AF"
                ...
                "6C79CE0584E49687FF61BC29AEA19000"
            .parseHex();

    final generalAuthenticateStep4MsgTerminal =
        "008600000C7C0A8508B46DD9BD4D98381F00".parseHex();
    final generalAuthenticateStep4MsgChip =
        "7C1B8608917F37B5C0E6D8D1870F444554455354435643413030303033".parseHex();
    ...
    final efCardAccessData =
        "31143012060A04007F00070202040102020102020100".parseHex();
    ...
    Uint8List step0terminal =
        PACE.generateAuthenticationTemplateForMutualAuthenticationData(
    ...
    Uint8List step1terminalAPDU = CommandAPDU(
    ...
    ResponseAPDUStep1Pace step1bChip =
    ...
    //
    BigInt calcSharedSecretChip =
        chip.getSharedSecret(otherPubKey: terminal.getPubKey().toBytes());
    BigInt calcSharedSecretTerminal =
    ...
    ResponseAPDUStep2or3Pace step2Chip =
        ResponseAPDUStep2or3Pace(generalAuthenticateStep2MsgChip);
    ...
    BigInt calcEphemeralSharedSecretTerminal =
        terminal.getEphemeralSharedSecret(
    ...
    Uint8List step3terminalAPDU = CommandAPDU(
            cla: ISO7816_CLA.COMMAND_CHAINING,
            ins: ISO7816_INS.GENERAL_AUTHENTICATE,
            p1: 0x00,
            p2: 0x00,
    ...
    ResponseAPDUStep2or3Pace step3Chip =
    ...
    Uint8List encryptedTByAES = aesCipher.encrypt(
        data: calcInputDataTTerminal, key: macKey, padding: true);
    Uint8List decryptedTByAES =
        aesCipher.decrypt(data: encryptedTByAES, key: macKey);

    expect(calcInputDataTTerminal.sublist(0, 147),
        decryptedTByAES.sublist(0, 147));

    Uint8List encryptedCByAES =
        aesCipher.encrypt(data: calcInputDataTChip, key: macKey, padding: true);
    Uint8List decryptedCByAES =
        aesCipher.decrypt(data: encryptedCByAES, key: macKey);

    expect(calcInputDataTChip.sublist(0, 147), decryptedCByAES.sublist(0, 147));

    //checking message of step 4
    Uint8List step4terminal =
        PACE.generateGeneralAuthenticateDataStep4(authToken: tifd);
    ...
    ResponseAPDUStep4Pace step4Chip =
